...
/////////////////
const BotName = 'RekberBOT'; 
const instagram = 'https://instagram.com/_kobongkobong'; 
const telegram = 'https://t.me/ArioFaris'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ArioFaris')
